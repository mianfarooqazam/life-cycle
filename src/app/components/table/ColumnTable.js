        ...
        <TableBody>
          {data.map((row) => (
            ...
            >
              ...
              <TableCell sx={cellStyle}>{row.numberOfColumns}</TableCell>
              <TableCell sx={cellStyle}>{row.columnHeight}</TableCell>
              <TableCell sx={cellStyle}>{row.columnLength}</TableCell>
              <TableCell sx={cellStyle}>{row.columnWidth}</TableCell>
