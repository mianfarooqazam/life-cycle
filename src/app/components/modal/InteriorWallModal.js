...
export default function InteriorWallModal({ open, onClose, selectedFloorName, floorNumber }) {
    // Zustand store hooks
    const {
        formData,
        doorForm,
                            ...
                            <>
                                ...
                                {formData.isTilesUsed === 'yes' && formData.tileHeight && !tileHeightError && (
                                    <div className="p-4 rounded-md" style={{ backgroundColor: '#f7f6fb', maxWidth: 350 }}>
                                        <p className="text-lg font-bold text-gray-800">
                                            Interior Wall Tiles Area: <span className="text-[#5BB045]">{calculateTilesArea()} ft²</span>
                                        </p>
                                    </div>
                                )}
